...
c Bins
      INTEGER*4 PPICLF_NDXGP, PPICLF_NDYGP, PPICLF_NDZGP
      COMMON /PPICLF_PARALLEL_BIN_GLOBAL_N/ PPICLF_NDXGP, PPICLF_NDYGP
     >                                     ,PPICLF_NDZGP

      REAL*8 PPICLF_RDXGP, PPICLF_RDYGP, PPICLF_RDZGP,PPICLF_BINB(6)
      COMMON /PPICLF_PARALLEL_BIN_GLOBAL_R/ PPICLF_RDXGP, PPICLF_RDYGP
     >                                     ,PPICLF_RDZGP, PPICLF_BINB
